...
const EditOrderForm = () => {
    ...
    const accountForm = (
        <div className="mt">
            ...
            <div>
                <label htmlFor="amount_wo_noat">
                    НӨАТ падаан бичээгүй дүн:
                </label>
                <input
                    type="number"
                    name="amount_wo_noat"
        ...
        <div className="mt">
            ...
            <div>
                ...
                <input
                    type="date"
                    name="date_left"
                    value={moment(new Date(orderData.date_left)).format(
                        "YYYY-MM-DD"
                    )}
                    onChange={handleDateChange}
                />
    ...
    let technicalContent = (
        <div className="mt">
            ...
            <div>
                <label
                    htmlFor="other1"
                    title="Хүлээн авагч өөрийн авто кран оруулахад"
                >
                    Бусад 1:
                </label>
                <input
