...
const getContentForDaysStayed = (numDays) => {
    ...
    if (numDays >= 1 || numDays === 0) {
        contentDays.push(
            `${
                extra_infos.days.one.text
            } ${extra_infos.days.one.price.toLocaleString("de-CH")}₮`
        );
    }
    ...
    if (numDays >= 2) {
        contentDays.push(
            `${
                extra_infos.days.two.text
            } ${extra_infos.days.two.price.toLocaleString("de-CH")}₮`
        );
    }
    ...
    return (
        <div>
            ...
            <div className="buttons">
                ...
                {isAdmin && (
                    <button onClick={() => handleDelete(orderId)}>
                        Устгах
                    </button>
                )}
            </div>
