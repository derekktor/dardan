...
const updateOrder = asyncHandler(async (req, res) => {
    ...
    order.forklift_usage = forklift_usage
        ? forklift_usage
        : order.forklift_usage;
    ...
    order.last_edited_by = last_edited_by
        ? last_edited_by
